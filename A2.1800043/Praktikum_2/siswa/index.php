...
<html lang="en">	<!-- tag pembuka HTML -->
	...
	Bootstrap 4">
	<meta name="author" content="Edwar Anas">
	...
	<footer class="pt-4 my-md-4 pt-md-3 border-top">
		<div class="row">
			<div class="col-12 col-md center">
				 &copy; 2020 -<a class="text-info" href="https://edwaranas.blogspot.com/">Edwar Anas</a> - <a class="text-info" href="https://stmik-sumedang.ac.id/">STMIK Sumedang</a> 
			</div>
		</div>
	</footer>
</div>
...
function getkey(e) {
	...
	//  jika  ukuran  file  yang  diupload  lebih  dari  sama  dengan  1 Mb
		...
		fileInput.value = '';
		document.getElementById('imagePreview').innerHTML = '<img class="foto-preview" src="foto/defaul.png"/>';
		return  false;
	}
	//  selain  itu
	else  {
