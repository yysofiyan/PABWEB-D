...
class Mahasiswa extends CI_Controller
{
    ...
    public function tambah_data()
    {
        ...
        $dropdown_prodi = form_dropdown($attr_prodi, $prodi);
    ...
    public function edit($id)
    {
        ...
        if ($get_row->num_rows() > 0) {
            ...
            $label_nama = form_label('Nama Mahasiswa', 'nama_mhs');
            $label_prodi = form_label('Program Studi', 'prodi');
            $input_nim = form_input($attr_nim, $nim);
            $input_nama = form_input($attr_nama, $nama_mhs);
            $input_id = form_input($attr_id);
            $get_prodi = $this->Mahasiswa_model->get_prodi();
            $prodi = array();
            foreach ($get_prodi as $r) {
            ...
            $dropdown_prodi = form_dropdown($attr_prodi, $prodi, $id_prodi);
            ...
            $this->load->view('editmhs_form', $data);
        } else {
