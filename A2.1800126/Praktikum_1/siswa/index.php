...
<html lang="en">
	...
	<body>
		...
		<div class="container-fluid">
		<?php
		// fungsi untuk pemangilan halaman
		...
		<!-- Pemanggil Library jQuery -->
		<!-- Pertama jQuery, kemudian Bootsrap js -->
		...
		<script type="text/javascript">
			...
			(function() {
				...
				window.addEventListener('load', function() {
					// Fetch all the forms we want to apply custom Bootsrap validation style to
