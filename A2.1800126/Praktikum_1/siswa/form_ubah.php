			...
			<div class="card-body">
				...
				<form class="needs-validation" action="proses_ubah.php" method="post" enctype="multipart/form-data" novalidate>
						...
						<div class="col">
							...
							<div class="form-group col-md-12">
								...
								if ($jenis_kelamin=='Laki-laki') { ?>
									...
									<div class="custom-control custom-radio mb-4">
										<input type="radio" class="custom-control-input" id="customControlValidation3" name="jenis_kelamin" value="Perenpuan" required>
							...
							<div class="form-group col-md-12">
								...
								<select class="form-control" name="agama" autocomplete="off" required>
									...
									<option value="Kristen Protestan">Kristen_protestan</option>
					...
					<div class="form-group col-md-12 right">
						<input type="submit" class="btn btn-info btn-submit mr-2" name="simpan">
						<a href="index.php" class="btn btn-secondary bts-reset"> Batal </a>
					</div>
				</form>
			</div>
		</div>
