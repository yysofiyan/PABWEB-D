...
<div class="row">
	...
	elseif ($_GET['alert'] == 1) { ?>
		<div class="alert alert-success alert-dismissible fade show" role="alert">
			<strong><i class="fas fa-check-cricle"></i>Sukses!</strong> Data siswa berhasil disimpan.
	...
	<div class="alert alert-danger alert-dismissible fade show" role="alert">
		<strong><i class="fas fa-time-circle"></i>Gagal!</strong> NIS <b><?php echo $_GET['nis']; ?></b> sudah ada.
	...
	<table class="table table-striped table-bordered">
		...
		<tbody>
			...
			// jika tidak dilakukan pencarian data
				...
				// perintah query untuk menamiplkan jumlah data siswa dari database
			...
			while ($data = mysqli_fetch_assoc($query)) { ?>
				...
				<!-- membuat tombol ubah dan hapus -->
					<td width="120" class="center">
						...
						<a title="Hapus" class="btn btn-outline-denger" href="proses_hapus.php?nis=<?php echo $data['nis'];?>" onclick="return confirm('Anda yakin ingin menghapus siswa <?php echo $data['nama']; ?>?');"><i class="fas fa-trash"></i></a>
					</td>
				</tr>
				<?php
					$no++;
		...
		<div class="col">
			<nav aria-label="Page navigation example">
				<ul class="pagination justify-content-end">
					...
					<!-- Button untuk link halman 1 2 3 ... -->
					<?php
					for($x=1; $x<=$halaman; $x++) { ?>
