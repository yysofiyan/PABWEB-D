...
<head>
	...
	<meta name="author" content="Agus Maulana Mubaroq">
...
<body>
		...
		<footer class="pt-4 my-md-4 pt-md-3 border-top">
			<div class="row">
				<div class="col-12 col-md center">
					&copy; 2020 - <a class="text-info" href="https://stmik-sumedang.ac.id/">STMIK Sumedang</a> & made by Agus Maulana Mubaroq
				</div>
			</div>
		</footer>
	</div>
	...
	<!-- Pertama jQuery, kemduian Bootstrap js -->
