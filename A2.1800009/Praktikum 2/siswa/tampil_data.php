			 		...
			 		<tbody>
			 			<?php 
			 				...
			 				if (isset($cari)) {
			 					...
			 					$query_jumlah = mysqli_query($db, "SELECT count(nis) as jumlah FROM tb_siswa WHERE nis LIKE '%$cari%' OR nama LIKE '%$cari%'") or die('Ada kesalahan pada query jumlah:'.mysqli_error($db));
			 				}
			 				// jika tidak dilakukan pencarian data
			 				else {
			 					// perintah query untuk menampilkan jumlah data siswa dari database
			 					$query_jumlah = mysqli_query($db, "SELECT count(nis) as jumlah FROM tb_siswa") or die('Ada kesalahan pada query jumlah:'.mysqli_error($db));
			 				}
			 				...
			 				if (isset($cari)) {
			 					...
			 					$query = mysqli_query($db, "SELECT * FROM tb_siswa WHERE nis LIKE '%$cari%' OR nama LIKE '%$cari%' ORDER BY nis DESC LIMIT $mulai, $batas") or die('Ada kesalahan pada query siswa: '.mysqli_error($db));
			 				}
			 				// jika tidak dilakukan pencarian data
			 				else {
			 					// perintah query untuk menampilkan data siswa dari database
			 					// data yang ditampilkan mulai = $mulai sampai dengan batas = $batas
			 					$query = mysqli_query($db, "SELECT * FROM tb_siswa ORDER BY nis DESC LIMIT $mulai, $batas") or die('Ada kesalahan pada query siswa: '.mysql_error($db));
			 				}
			 				// tampilkan data
