...
if (isset($_POST['simpan'])) {
	...
	$query = mysqli_query($db, "SELECT nis FROM tb_siswa WHERE nis='$nis'") or die('Ada kesalahan pada query tampil data nis: '.mysqli_error($db));
	...
	// jika nis belum ada
		...
		if (move_uploaded_file($tmp_file, $path)) {
			...
			$insert = mysqli_query($db, "INSERT INTO tb_siswa(nis,nama,tempat_lahir, tgl_lahir,jenis_kelamin,agama,alamat,no_hp,foto) VALUES('$nis','$nama','$tempat_lahir','$tanggal_lahir','$jenis_kelamin','$agama','$alamat','$no_hp','$nama_file')") or die('Ada kesalahan pada query insert : '.mysqli_error($db));
			// cek query
			if ($insert) {
