                        ...
                        <div class="col">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                foreach ($list_jk as $n => $jk) {
                                    $checked = $jk == $jenis_kelamin ? ' checked' : '';
                                ?>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" id="customControlValidation<?= $n ?>" name="jenis_kelamin" value="<?= $jk ?>" required <?= $checked ?>>
