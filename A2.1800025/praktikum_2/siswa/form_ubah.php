...
if (isset($_GET['nis'])) {
	...
	$query = mysqli_query($db, "SELECT * FROM tabel_siswa WHERE nis='$nis'") or die('Query Error : '.mysqli_error($db));
					...
					<div class="row">
						<div class="col">
							...
							<div class="form-group col-md-12">
								...
								<div class="invalid-feedback">Nama sswa tidak boleh kosong </div>
							</div>
