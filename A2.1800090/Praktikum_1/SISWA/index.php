...
<head>
    ...
    <meta name="author" content="Fiqri Fardiyanto">
    <link rel="shortcut icon" href="assets/img/favicon.png">
    <link rel="stylesheet" type="text/css" href="assets/plugins/bootstrap/bootstrap-4.1.3/dist/css/bootstrap.min.css">
...
<body>
        ...
        <footer class="pt-4 my-md-4 pt-md-3 border-top">
            <div class="row">
                <div class="col-12 col-md center">
                    &copy; Copyright 2020 - <a class="text-info" href="https://stmik-sumedang.ac.id/">STMIK Sumedang </a> by Fiqri Fardiyanto
                </div>
            </div>
        </footer>
    </div>
    ...
    <script type="text/javascript" src="assets/plugins/bootstrap/bootstrap-4.1.3/dist/js/bootstrap.min.js"></script>
        ...
        function konfirmasiHapus(nis) {
            swal({
                ...
                swal({
                    ...
                    function() {
                        window.location.href = "proses_hapus.php?nis=" + nis;
                    })
            });
        }
    </script>
