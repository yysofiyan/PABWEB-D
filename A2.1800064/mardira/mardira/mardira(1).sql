...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Jun 2020 pada 12.02
...
(123, 'hilal@gmail.com', 'hilal hamdi', '202cb962ac59075b964b07152d234b70');
...
--
ALTER TABLE `users`
  MODIFY `id_users` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1234;
COMMIT;
