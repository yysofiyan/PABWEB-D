...
<head>
    ...
    <meta name="author" content="Hilal Hamdi">
    ...
    <title>A2.1800064   |   HilalHamdi</title>
</head>
        ...
        <footer class="pt-4 my-md-4 pt-md-3 border-top">
            <div class="row">
                <div class="col-12 col-md center">
                    &copy; 02-04-2020 - <a class="text-info" href="https://stmik-sumedang.ac.id/">@STMIK sumedang</a>
                </div>
            </div>
        </footer>
    </div>
