...
class Mahasiswa extends CI_Controller
{
    ...
    public function _rules()
    {
        ...
        $this->form_validation->set_rules('nim', 'NIM', 'trim|required|numeric|min_length[5]|max_length[8]', $attr_nim);
        $this->form_validation->set_rules('nama_mhs', 'Nama Mahasiswa', 'trim|required|min_length[3]|max_length[50]', $attr_nama);
    }
